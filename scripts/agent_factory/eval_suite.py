...
def _generate_fixture_data(
    ...
    return _parse_json_lenient(json_text)
...
def _save_task(task_dir: Path, task_json: dict, fixture_data: dict) -> None:
    ...
    for file_entry in fixture_data.get("files", []):
        ...
        # Strip absolute path prefixes generated by LLM (e.g. /mnt/session/uploads/project/)
        raw_path = re.sub(r"^/mnt/session/uploads/project/?", "", raw_path)
        raw_path = raw_path.lstrip("/")
        file_path = fixture_dir / raw_path
