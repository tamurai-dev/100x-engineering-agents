...
Usage:
    from duet_factory.skill_resolver import resolve_skills
...
def resolve_skills(
    ...
    """Resolve the optimal skill configuration for a duet.
    ...
    Args:
        artifact_format: Duet artifact format (e.g., "presentation")
